export const REQUEST_TYPE = '_REQUEST_TYPE';
export const SUCCESS_TYPE = '_SUCCESS_TYPE';
...
export const DETAIL_DEVICES = 'DETAIL_DEVICES';
...
export const LIST_LOCATION_TRANSACTION = 'LIST_LOCATION_TRANSACTION';
export const LIST_OUTLET_TRANSACTION = 'LIST_OUTLET_TRANSACTION';
